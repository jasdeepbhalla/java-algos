...
// The simplest approach is to sort the entire input array & then access the element by it's index (which is O(1)) operation.
...
// so that even when the worst case input would be provided the algorithm wouldn't be affected. 
