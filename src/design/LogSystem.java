 ...
 * Example 1:
 * 
 * put(1, "2017:01:01:23:59:59"); put(2, "2017:01:01:22:59:59"); put(3,
 * "2016:01:01:00:00:00");
 ...
 * Note:
 * 
 * There will be at most 300 operations of Put or Retrieve. Year ranges from
 * [2000,2017]. Hour ranges from [00,23]. Output for Retrieve has no order
 * required.
 */
...
public class LogSystem {
	...
	List<String> units = Arrays.asList("Year", "Month", "Day", "Hour",
			"Minute", "Second");
	...
	public List<Integer> retrieve(String s, String e, String gra) {
		...
		for (String[] timestamp : timestamps) {
			if (timestamp[1].substring(0, idx).compareTo(s.substring(0, idx)) >= 0
					&& timestamp[1].substring(0, idx).compareTo(
							e.substring(0, idx)) <= 0)
